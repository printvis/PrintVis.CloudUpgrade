codeunit 80002 "PTE Internal Move Data"
{
    TableNo = 80001;
    ...
    local procedure MoveData(var PTETablesStatus: Record "PTE Tables Status")
    begin
        CASE PTETablesStatus.TableNo OF
            13:
                m13(PTETablesStatus);
            14:
                m14(PTETablesStatus);
    ...
    local procedure m13(var P: Record "PTE Tables Status")
    var
        t: Record 13;
        tx: Record 80013;
    begin
    ...
    local procedure m14(var P: Record "PTE Tables Status")
    var
        t: Record 14;
        tx: Record 80014;
    begin
    ...
    local procedure m15(var P: Record "PTE Tables Status")
    var
        t: Record 15;
        tx: Record 80015;
    begin
    ...
    local procedure m17(var P: Record "PTE Tables Status")
    var
        t: Record 17;
        tx: Record 80017;
    begin
    ...
    local procedure m18(var P: Record "PTE Tables Status")
    var
        t: Record 18;
        tx: Record 80018;
    begin
    ...
    local procedure m23(var P: Record "PTE Tables Status")
    var
        t: Record 23;
        tx: Record 80023;
    begin
    ...
    local procedure m27(var P: Record "PTE Tables Status")
    var
        t: Record 27;
        tx: Record 80027;
    begin
    ...
    local procedure m32(var P: Record "PTE Tables Status")
    var
        t: Record 32;
        tx: Record 80032;
    begin
    ...
    local procedure m36(var P: Record "PTE Tables Status")
    var
        t: Record 36;
        tx: Record 80036;
    begin
    ...
    local procedure m37(var P: Record "PTE Tables Status")
    var
        t: Record 37;
        tx: Record 80037;
    begin
    ...
    local procedure m38(var P: Record "PTE Tables Status")
    var
        t: Record 38;
        tx: Record 80038;
    begin
    ...
    local procedure m39(var P: Record "PTE Tables Status")
    var
        t: Record 39;
        tx: Record 80039;
    begin
    ...
    local procedure m51(var P: Record "PTE Tables Status")
    var
        t: Record 51;
        tx: Record 80051;
    begin
    ...
    local procedure m81(var P: Record "PTE Tables Status")
    var
        t: Record 81;
        tx: Record 80081;
    begin
    ...
    local procedure m83(var P: Record "PTE Tables Status")
    var
        t: Record 83;
        tx: Record 80083;
    begin
    ...
    local procedure m110(var P: Record "PTE Tables Status")
    var
        t: Record 110;
        tx: Record 80110;
    begin
    ...
    local procedure m111(var P: Record "PTE Tables Status")
    var
        t: Record 111;
        tx: Record 80111;
    begin
    ...
    local procedure m112(var P: Record "PTE Tables Status")
    var
        t: Record 112;
        tx: Record 80112;
    begin
    ...
    local procedure m113(var P: Record "PTE Tables Status")
    var
        t: Record 113;
        tx: Record 80113;
    begin
    ...
    local procedure m114(var P: Record "PTE Tables Status")
    var
        t: Record 114;
        tx: Record 80114;
    begin
    ...
    local procedure m115(var P: Record "PTE Tables Status")
    var
        t: Record 115;
        tx: Record 80115;
    begin
    ...
    local procedure m121(var P: Record "PTE Tables Status")
    var
        t: Record 121;
        tx: Record 80121;
    begin
    ...
    local procedure m123(var P: Record "PTE Tables Status")
    var
        t: Record 123;
        tx: Record 80123;
    begin
    ...
    local procedure m125(var P: Record "PTE Tables Status")
    var
        t: Record 125;
        tx: Record 80125;
    begin
    ...
    local procedure m224(var P: Record "PTE Tables Status")
    var
        t: Record 224;
        tx: Record 80224;
    begin
    ...
    local procedure m246(var P: Record "PTE Tables Status")
    var
        t: Record 246;
        tx: Record 80246;
    begin
    ...
    local procedure m251(var P: Record "PTE Tables Status")
    var
        t: Record 251;
        tx: Record 80251;
    begin
    ...
    local procedure m279(var P: Record "PTE Tables Status")
    var
        t: Record 279;
        tx: Record 80279;
    begin
    ...
    local procedure m325(var P: Record "PTE Tables Status")
    var
        t: Record 325;
        tx: Record 80325;
    begin
    ...
    local procedure m1300(var P: Record "PTE Tables Status")
    var
    ...
    local procedure m1301(var P: Record "PTE Tables Status")
    var
        t: Record "Item Templ.";
        tx: Record 81301;
    begin
    ...
    local procedure m5050(var P: Record "PTE Tables Status")
    var
        t: Record 5050;
        tx: Record 85050;
    begin
    ...
    local procedure m5065(var P: Record "PTE Tables Status")
    var
        t: Record 5065;
        tx: Record 85065;
    begin
    ...
    local procedure m5080(var P: Record "PTE Tables Status")
    var
        t: Record 5080;
        tx: Record 85080;
    begin
    ...
    local procedure m5107(var P: Record "PTE Tables Status")
    var
        t: Record 5107;
        tx: Record 85107;
    begin
    ...
    local procedure m5108(var P: Record "PTE Tables Status")
    var
        t: Record 5108;
        tx: Record 85108;
    begin
    ...
    local procedure m5109(var P: Record "PTE Tables Status")
    var
        t: Record 5109;
        tx: Record 85109;
    begin
    ...
    local procedure m5110(var P: Record "PTE Tables Status")
    var
        t: Record 5110;
        tx: Record 85110;
    begin
    ...
    local procedure m5401(var P: Record "PTE Tables Status")
    var
        t: Record 5401;
        tx: Record 85401;
    begin
    ...
    local procedure m6651(var P: Record "PTE Tables Status")
    var
        t: Record 6651;
        tx: Record 86651;
    begin
    ...
    local procedure m6661(var P: Record "PTE Tables Status")
    var
        t: Record 6661;
        tx: Record 86661;
    begin
    ...
    local procedure m7312(var P: Record "PTE Tables Status")
    var
        t: Record 7312;
        tx: Record 87312;
    begin
    ...
    local procedure m7326(var P: Record "PTE Tables Status")
    var
        t: Record 7326;
        tx: Record 87326;
    begin
    ...
    local procedure m7347(var P: Record "PTE Tables Status")
    var
        t: Record 7347;
        tx: Record 87347;
    begin
